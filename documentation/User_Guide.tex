...
\v|Differentiation| contains information about a Cell's ability (or lack thereof) to convert to other cell types during cell division. Its main data elements include:
